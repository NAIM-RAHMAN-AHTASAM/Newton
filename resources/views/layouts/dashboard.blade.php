    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <?php if (Auth::user()->role==1): ?>
          ...
          <a href="{{url('add/faq')}}" class="sl-menu-link @yield('addfaq')">
            <div class="sl-menu-item">
              <i class="icon ion-help-circled tx-20"></i>
          ...
          <a href="{{ route('category.index') }}" class="sl-menu-link @yield('category')">
            <div class="sl-menu-item">
              <i class="fa fa-list-alt tx-24"></i>
          ...
          <a href="{{route('view_report')}}" class="sl-menu-link @yield('view_report')">
            <div class="sl-menu-item">
              <i class="fa fa-file tx-24"></i>
              <span class="menu-item-label">Report Genarate</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
          ...
          <a href="{{route('coupon.index')}}" class="sl-menu-link @yield('coupon')">
            <div class="sl-menu-item">
              <i class="fa fa-gift tx-24"></i>
              <span class="menu-item-label">Add Coupon</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->

          @can('see role manage')
          <a href="{{route('role.index')}}" class="sl-menu-link @yield('role')">
            <div class="sl-menu-item">
        ...
        @endcan
          <a href="{{route('contact.index')}}" class="sl-menu-link @yield('contact_admin')">
            <div class="sl-menu-item">
              <i class="fa fa-phone tx-24"></i>
              <span class="menu-item-label">Contact</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
          <a href="{{route('all_graph')}}" class="sl-menu-link @yield('graph')">
            <div class="sl-menu-item">
              <i class="fa fa-line-chart tx-24"></i>
              <span class="menu-item-label">All graph</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
          <?php else: ?>
        ...
        <a href="mailbox.html" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Reserve</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              {{-- {{ asset('uploads/product_thumbnail') }}/{{ $product->product_thumbnail_image }} --}}
              {{-- <img src="{{ asset('public/profile_images') }}/{{ Auth::user()->image }}" class="wd-32 rounded-circle" alt=""> --}}
              @if(Auth::user()->image != null)<img src="{{url(Auth::user()->image)}}" class="wd-32 rounded-circle" alt="">@endif
            </a>


            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href="{{ route('view_profile')}}"><i class="icon ion-ios-person-outline"></i> View Profile</a></li>
                <li><a href="{{ route('update_profile')}}"><i class="icon ion-ios-person-outline"></i> Update Profile</a></li>
                <li><a href="{{ route('edit_profile')}}"><i class="icon ion-ios-person-outline"></i> Edit Password</a></li>
